...
class CredentialServiceImpl : KoinComponent, CredentialService {
    ...
    override suspend fun createCredential(
        ...
        val userHrn = ResourceHrn(usersService.getUser(organizationId, subOrganizationId, userId).hrn)
    ...
    override suspend fun getCredentialWithoutSecret(
        ...
        val userHrn = ResourceHrn(organizationId, subOrganizationId, IamResources.USER, userId)
    ...
    override suspend fun deleteCredential(
        ...
        if (!repo.delete(organizationId, subOrganizationId, userId, id)) {
...
interface CredentialService {
    ...
    suspend fun deleteCredential(organizationId: String, subOrganizationId: String?, userId: String, id: UUID):
        BaseSuccessResponse
    suspend fun listCredentials(organizationId: String, subOrganizationId: String?, userId: String):
        ListCredentialResponse
}
